...
namespace CoreLand.UI.CustomControls.ExtendedControls
{
    ...
    /// </summary>
    [TemplatePart(Name = EPasswordBoxStrings.ButtonXAMLName, Type = typeof(Button))]
    public partial class EPasswordBox : TextBox
    {
        ...
        {
            ((Button)Template.FindName(EPasswordBoxStrings.ButtonXAMLName, this)).PreviewMouseDown += EPasswordBox_MouseLeftButtonDown;
            ((Button)Template.FindName(EPasswordBoxStrings.ButtonXAMLName, this)).PreviewMouseUp += EPasswordBox_MouseLeftButtonUp;
        }
        ...
        private void EPasswordBox_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            this.IsPasswordMasked = true;
        }

        private void EPasswordBox_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
        ...
        private void _UnInitializeEvents()
        {
            ...
            Loaded -= (_, __) =>
            {
                ((Button)Template.FindName(EPasswordBoxStrings.ButtonXAMLName, this)).MouseLeftButtonDown -= EPasswordBox_MouseLeftButtonDown;
                ((Button)Template.FindName(EPasswordBoxStrings.ButtonXAMLName, this)).MouseLeftButtonUp -= EPasswordBox_MouseLeftButtonUp;
            };
        }
